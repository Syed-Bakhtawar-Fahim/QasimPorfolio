...
const Services = () => {
    ...
    return (
        <section className="services section" id="services">
            ...
            <span className="section__subtitle">I don't sell Websites
                I create websites that Sell</span>

            <div className="services__container container grid">
                <div className="services__content">
                    <div>
                        <HiOutlineClipboardList className="services__icon" />
                        <h3 className="services__title">Web Application - Frontend<br />Development</h3>
                    </div>
                    ...
                    <div className={toggleState === 1 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                People ignore design that ignore people thats why you need awesome frontend developer
                            </p>
