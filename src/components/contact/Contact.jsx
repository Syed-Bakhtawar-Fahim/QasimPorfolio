            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">kasimcruze0@gmail.com</span>
                    ...
                    <div className="contact__card">
                        <IoIosContact  className="contact__card-icon" />
                        
                        <h3 className="contact__card-title">Contact</h3>
                        <span className="contact__card-data">+92 3162952396</span>
                    </div>
                </div>
            </div>
